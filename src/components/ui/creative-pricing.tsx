  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <div className="relative p-6">
              ...
              <div className="mb-6 font-handwritten">
                ...
                <span className="text-zinc-600 dark:text-zinc-400">/once</span>
              </div>
      ...
      <div className="absolute -z-10 inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-40 left-20 text-4xl rotate-12 select-none">✎</div>
        <div className="absolute bottom-40 right-20 text-4xl -rotate-12 select-none">✏️</div>
      </div>
    </div>
  )
}
